...
const createRent = async (req, res) => {
    ...
    try {
        const { platenumber, initialdate, finaldate, rentnumber } = req.body;
        ...
        const rent = new Rent({ platenumber, initialdate: isoInitialDate, finaldate: isoFinalDate, rentnumber});
        await rent.save();

        res.status(200).json({ mensaje: 'Renta creada exitosamente' });
